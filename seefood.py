...
def multiline_textsize(img, text, font=None):
    (text_left, text_top, text_right, text_bottom) = img.multiline_textbbox((0,0), text, font=font)
    text_width, text_height = text_right - text_left, text_bottom - text_top
    return (text_width, text_height)

# ImageDraw.ImageDraw.multiline_textsize = MethodType(multiline_textsize, None, ImageDraw.ImageDraw)
setattr(ImageDraw.ImageDraw, "multiline_textsize", multiline_textsize)
...
def label_image(img, confidence=50):
    ...
    response = rekognition_client.detect_labels(Image={'Bytes': img_bytes},    MinConfidence=confidence )
    ...
    img_pillow = get_pillow_img(img_bytes)
    ...
    final = add_text_to_img(img_pillow, label_text, pos=(xpos, ypos), color=label_color, bgcolor=box_color, font=ImageFont.truetype('ariblk.ttf', 30))
...
if __name__ == "__main__":
    ...
    #img = r"C:\Users\user\Downloads\Hot_dog_with_mustard.png"
    #img = r"C:\Users\user\Downloads\veg-noodles-vegetable-noodles-recipe.jpg"
